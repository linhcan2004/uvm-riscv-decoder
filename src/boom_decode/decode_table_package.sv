package decode_table_package;
  ...
  // All loads share the same ctrl signals; mem_size/mem_signed come from inst bits
  ...
  decode_ctrl_sig_s LD_struct   = '{Y,N,X, uopLD,   IQT_MEM, FU_MEM, RT_FIX, RT_FIX, RT_X,  N, IS_I, Y,N,N,N,N, M_XRD, 3, N,N,N,N,N, CSR_N, uopLD}; // RV64
  decode_ctrl_sig_s LWU_struct  = '{Y,N,X, uopLD,   IQT_MEM, FU_MEM, RT_FIX, RT_FIX, RT_X,  N, IS_I, Y,N,N,N,N, M_XRD, 3, N,N,N,N,N, CSR_N, uopLD}; // RV64
  ...
  decode_ctrl_sig_s SD_struct   = '{Y,N,X, uopSTA,  IQT_MEM, FU_MEM, RT_X,   RT_FIX, RT_FIX,N, IS_S, N,Y,N,N,N, M_XWR, 0, N,N,N,N,N, CSR_N, uopSTA}; // RV64

  // OP-IMM (I-type, opcode=0010011)
  ...
  decode_ctrl_sig_s ADD_struct   = '{Y,N,X, uopADD,  IQT_INT, FU_ALU, RT_FIX, RT_FIX, RT_FIX,N, IS_X, N,N,N,N,N, M_X, 1, Y,N,N,N,N, CSR_N, uopADD};
  decode_ctrl_sig_s SUB_struct   = '{Y,N,X, uopSUB,  IQT_INT, FU_ALU, RT_FIX, RT_FIX, RT_FIX,N, IS_X, N,N,N,N,N, M_X, 1, Y,N,N,N,N, CSR_N, uopSUB};
  decode_ctrl_sig_s SLL_struct   = '{Y,N,X, uopSLL,  IQT_INT, FU_ALU, RT_FIX, RT_FIX, RT_FIX,N, IS_X, N,N,N,N,N, M_X, 1, Y,N,N,N,N, CSR_N, uopSLL};
  decode_ctrl_sig_s SLT_struct   = '{Y,N,X, uopSLT,  IQT_INT, FU_ALU, RT_FIX, RT_FIX, RT_FIX,N, IS_X, N,N,N,N,N, M_X, 1, Y,N,N,N,N, CSR_N, uopSLT};
  decode_ctrl_sig_s SLTU_struct  = '{Y,N,X, uopSLTU, IQT_INT, FU_ALU, RT_FIX, RT_FIX, RT_FIX,N, IS_X, N,N,N,N,N, M_X, 1, Y,N,N,N,N, CSR_N, uopSLTU};
  decode_ctrl_sig_s XOR_struct   = '{Y,N,X, uopXOR,  IQT_INT, FU_ALU, RT_FIX, RT_FIX, RT_FIX,N, IS_X, N,N,N,N,N, M_X, 1, Y,N,N,N,N, CSR_N, uopXOR};
  ...
  decode_ctrl_sig_s SRA_struct   = '{Y,N,X, uopSRA,  IQT_INT, FU_ALU, RT_FIX, RT_FIX, RT_FIX,N, IS_X, N,N,N,N,N, M_X, 1, Y,N,N,N,N, CSR_N, uopSRA};
  decode_ctrl_sig_s OR_struct    = '{Y,N,X, uopOR,   IQT_INT, FU_ALU, RT_FIX, RT_FIX, RT_FIX,N, IS_X, N,N,N,N,N, M_X, 1, Y,N,N,N,N, CSR_N, uopOR};
  decode_ctrl_sig_s AND_struct   = '{Y,N,X, uopAND,  IQT_INT, FU_ALU, RT_FIX, RT_FIX, RT_FIX,N, IS_X, N,N,N,N,N, M_X, 1, Y,N,N,N,N, CSR_N, uopAND};
  ...
  decode_ctrl_sig_s JALR_struct  = '{Y,N,X, uopJALR, IQT_INT, FU_ALU, RT_FIX, RT_FIX, RT_X,  N, IS_I, N,N,N,N,N, M_X, 1, N,N,N,N,N, CSR_N, uopJALR};
  ...
  decode_ctrl_sig_s FENCEI_struct = '{Y,N,X, uopNOP,    IQT_INT, FU_X,   RT_X, RT_X, RT_X, N, IS_X, N,N,N,N,Y, M_X, 0, N,N,N,Y,Y, CSR_N, uopNOP};
  ...
  decode_ctrl_sig_s ADDW_struct  = '{Y,N,X, uopADDW, IQT_INT, FU_ALU, RT_FIX, RT_FIX, RT_FIX,N, IS_X, N,N,N,N,N, M_X, 1, Y,N,N,N,N, CSR_N, uopADDW};
  decode_ctrl_sig_s SUBW_struct  = '{Y,N,X, uopSUBW, IQT_INT, FU_ALU, RT_FIX, RT_FIX, RT_FIX,N, IS_X, N,N,N,N,N, M_X, 1, Y,N,N,N,N, CSR_N, uopSUBW};
  decode_ctrl_sig_s SLLW_struct  = '{Y,N,X, uopSLLW, IQT_INT, FU_ALU, RT_FIX, RT_FIX, RT_FIX,N, IS_X, N,N,N,N,N, M_X, 1, Y,N,N,N,N, CSR_N, uopSLLW};
  ...
  decode_ctrl_sig_s SRAW_struct  = '{Y,N,X, uopSRAW, IQT_INT, FU_ALU, RT_FIX, RT_FIX, RT_FIX,N, IS_X, N,N,N,N,N, M_X, 1, Y,N,N,N,N, CSR_N, uopSRAW};

  // RV32M (opcode=0110011, funct7=0000001)
  ...
  // RV64M (opcode=0111011, funct7=0000001)
  ...
  // RV32A (opcode=0101111, funct3=010)
  ...
  decode_ctrl_sig_s SC_W_struct       = '{Y,N,X, uopAMO_AG, IQT_MEM, FU_MEM, RT_FIX, RT_FIX, RT_FIX,N, IS_X, N,Y,N,Y,N, M_XSC,    0, N,N,N,Y,Y, CSR_N, uopAMO_AG};
  ...
  // RV64A (opcode=0101111, funct3=011)
